...
python main.py parse --input 2003_12\fetched_2003_12.txt --output 2003_12
python main.py group --input 2003_12\parsed.json --output 2003_12\queries.json --threshold 0.01 --jaccard 0.8 --modifiers top
