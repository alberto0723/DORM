...
python main.py parse --input 2025_05\fetched_2025_05.txt --output 2025_05\parsed.json
python main.py clean --input 2025_05\parsed.json --output 2025_05\cleaned.json
python main.py group --input 2025_05\cleaned.json --output 2025_05\queries.json --threshold 0.01 --jaccard 0.8 --modifiers top
